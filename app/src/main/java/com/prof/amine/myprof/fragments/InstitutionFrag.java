 ...
 */
public class InstitutionFrag extends Fragment {
    private Button activateAppar;

    public InstitutionFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activateAppar=(Button)view.findViewById(R.id.BtnActivateAppar1);
        activateAppar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment fragment=null;
                fragment=new ActivateAppartenanceFrag();
                if(fragment!=null) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("المؤسسة:ثا.إبن سينا");
